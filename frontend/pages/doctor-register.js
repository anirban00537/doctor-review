...
const Signup = () => {
  ...
  const [otherImportantLink, setOtherImportantLink] = useState(""); // New other important link state
  const router = useRouter();
  const SignupSubmit = async (e) => {
    e.preventDefault();
    const response = await RegisterDoctorApi(
      email,
      password,
      name,
      education,
          ...
          <div className="max-w-xl lg:max-w-3xl">
            ...
            >
              ...
              <div className="col-span-6">
                ...
                <input
                  type="text"
                  id="OtherImportantLink"
                  name="otherImportantLink"
                  value={otherImportantLink}
                  onChange={(e) => setOtherImportantLink(e.target.value)}
                  className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                />
              </div>
              <div className="col-span-6">
